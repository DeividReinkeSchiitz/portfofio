...
export default function MobileImages({images}: { images: string[] }) {
    return (
        <div className={"hidden md:flex"}>
            <div className={"max-w-[420px] w-[25vw] h-auto mt-5 absolute top-[-100px] left-[-22vw] "}>
            ...
            <div className={"max-w-[420px] w-[25vw] h-auto mt-5 absolute top-[300px] left-[-23vw] "}>
            ...
            <div className={"max-w-[420px] w-[25vw] h-auto mt-5 absolute top-[270px] right-[-18vw] "}>
